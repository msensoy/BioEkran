#pragma checksum "C:\Users\MONSTER\GitHub\BioEkran\UygulamaUI\Views\TrackingNetwork\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "ec78acdf2fc3f872b0d5acdf37e4ffb9731c14f6"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"ec78acdf2fc3f872b0d5acdf37e4ffb9731c14f6", @"/Views/TrackingNetwork/Index.cshtml")]
...
<div class=""container"">
 ...
 ");
            WriteLiteral(@"                       <button type=""button"" class=""btn cancel"" onclick=""closeForm()"">
                ...
                <div class=""row ml-1"" style=""height:35%;width:100%;padding-left:130px;"">
                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("img", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "ec78acdf2fc3f872b0d5acdf37e4ffb9731c14f66183", async() => {
            }
            );
            ...
            WriteLiteral(@"
                ...
                <div style=""height:20%;width:100%; margin-top:-80px; margin-left:30px;"">
                    <div class=""row"" style=""width:30%; font-size:xx-large; color:forestgreen"">
                        <div><span>pH:&nbsp</span></div>
                        <div id=""pHLevel""></div></div>
                    <div style=""width:30%; font-size:xx-large; color:rgba(11, 137, 11, 0.63)"">İYİ</div>
                </div>
                <hr />
                <div>
                    ...
                    <div class=""degerler row justify-content-between m-2 pl-3 border-bottom"">
                        <div>pH:</div>
                        <div id=""ph2Level"" class=""mr-5""></div>
                    </div>
                    ...
                    <div class=""degerler row justify-content-b");
            WriteLiteral(@"etween m-2 pl-3 border-bottom"">
                        <div>KOİ</div>
                    ...
                    <div class=""degerler row justify-content-between m-2 pl-3 "">
                        <div>Su Seviyesi</div>
                        <div id=""deviceWaterLevel"" class=""mr-5"">0</div>
                    </div>
                </div>
            </div>
...
");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "ec78acdf2fc3f872b0d5acdf37e4ffb9731c14f69374", async() => {
            }
            );
            __Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.Razor.TagHelpers.UrlResolutionTagHelper>();
            __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper);
    ...
    function openForm() {
        ...
        $.ajax({
            ...
            success: function (veriler) {
                $(""#deviceWaterLe");
            WriteLiteral(@"vel"").html(veriler.device.waterLevel);
                $(""#pHLevel"").html(veriler.phLevel);
                $(""#ph2Level"").html(veriler.phLevel);
